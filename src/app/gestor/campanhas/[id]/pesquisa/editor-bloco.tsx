    ...
    <>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <Select
            value={bloco.obrigatoria ? "sim" : "nao"}
            onChange={(e) => onPatch({ obrigatoria: e.target.value === "sim" })}
          >
        ...
        <div>
          ...
          <div className="space-y-2.5">
            {hook.parametros.map((p) => (
              <div key={p.nome} className="grid grid-cols-12 gap-2.5 items-center">
                <div className="col-span-4">
                  <span className="mono text-sm">{p.nome}</span>
                  {p.descricao && (
